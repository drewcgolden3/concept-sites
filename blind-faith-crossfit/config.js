/* =========================================================================
   BLIND FAITH CROSSFIT — CONCEPT SITE CONFIG
   -------------------------------------------------------------------------
...
window.SITE_CONFIG = {
  ...
  brand: {
    name: "Blind Faith CrossFit",
    shortName: "BF",
    tagline: "CrossFit in North Haven",
  },

  contact: {
    venueName: "Blind Faith CrossFit",
    address: "North Haven, CT",
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Blind+Faith+CrossFit+North+Haven+CT",
    phone: "",
    phoneHref: "",
    email: "",
  },
  ...
  booking: {
    court: {
      type: "embed",
      demo: true,
      embedUrl: "https://book.blindfaithcrossfit.example/schedule",
      title: "Book a WOD",
