...
window.SITE_CONFIG = {
  ...
  brand: {
    name: "McEnroe Fitness",
    shortName: "MF",
    tagline: "Personal Training & Group Fitness in Winsted",
  },

  contact: {
    venueName: "McEnroe Fitness",
    address: "Winsted, CT",
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=McEnroe+Fitness+Winsted+CT",
    phone: "",
    phoneHref: "",
    email: "",
  },
  ...
  booking: {
    court: {
      type: "embed",
      demo: true,
      embedUrl: "https://book.mcenroe-fitness.example/schedule",
      title: "Book a Session",
      subtitle: "Pick a time that works. Confirmed in a couple of taps.",
      services: [{"name": "Personal training", "meta": "60 min \u00b7 1-on-1"}, {"name": "Group fitness", "meta": "45 min \u00b7 up to 10"}],
      fallbackEmail: {
        to: "hello@example.com",
        subject: "Book a Session",
        body: "Hi McEnroe Fitness,\n\nI'd like to book a session. Here are my details:\n\n- Name:\n- Goal:\n- Preferred days & times:\n\nThank you!",
      },
    },
    ...
    camp: {
      ...
      fallbackEmail: {
        ...
        body: "Hi,\n\nI'd like to register for Sports Performance.\n\nThank you!",
      },
    },
