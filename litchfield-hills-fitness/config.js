/* =========================================================================
   LITCHFIELD HILLS FITNESS — CONCEPT SITE CONFIG
   -------------------------------------------------------------------------
...
window.SITE_CONFIG = {
  ...
  brand: {
    name: "Litchfield Hills Fitness",
    shortName: "LH",
    tagline: "Gym & Personal Training in Litchfield",
  },

  contact: {
    venueName: "Litchfield Hills Fitness",
    address: "Litchfield, CT",
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Litchfield+Hills+Fitness+Litchfield+CT",
    phone: "",
    phoneHref: "",
    email: "",
  },
  ...
  booking: {
    court: {
      type: "embed",
      demo: true,
      embedUrl: "https://book.litchfieldhillsfitness.example/schedule",
