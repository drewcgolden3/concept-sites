/* =========================================================================
   THE WORKOUT LOUNGE — CONCEPT SITE CONFIG
   -------------------------------------------------------------------------
...
window.SITE_CONFIG = {
  ...
  brand: {
    name: "The Workout Lounge",
    shortName: "WL",
    tagline: "Personal Training & Group Fitness in Norwalk",
  },

  contact: {
    venueName: "The Workout Lounge",
    address: "Norwalk, CT",
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=The+Workout+Lounge+Norwalk+CT",
    phone: "",
    phoneHref: "",
    email: "Csinatra26@gmail.com",
  },
  ...
  booking: {
    court: {
      type: "embed",
      demo: true,
      embedUrl: "https://book.the-workout-lounge.example/schedule",
      title: "Book a Session",
      subtitle: "Pick a time that works. Confirmed in a couple of taps.",
      services: [{"name": "Personal training", "meta": "60 min · 1-on-1"}, {"name": "Group fitness class", "meta": "45 min · small group"}],
      fallbackEmail: {
        to: "Csinatra26@gmail.com",
        subject: "Book a Session",
        body: "Hi Workout Lounge team,\n\nI'd like to book a session. Here are my details:\n\n- Name:\n- Goal:\n- Preferred days & times:\n\nThank you!",
      },
    },
    ...
    pickleball: {
      ...
      fallbackEmail: {
        ...
        body: "Hi,\n\nI'd like to reserve a spot in a group fitness class.\n\nThank you!",
      },
    },
