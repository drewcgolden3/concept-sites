/* =========================================================================
   WOODBURY FIT ON MAIN — CONCEPT SITE CONFIG
   -------------------------------------------------------------------------
...
window.SITE_CONFIG = {
  ...
  brand: {
    name: "Woodbury Fit on Main",
    shortName: "WFM",
    tagline: "Strength & Conditioning in Woodbury",
  },

  contact: {
    venueName: "Woodbury Fit on Main",
    address: "Woodbury, CT",
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Woodbury+Fit+on+Main+Woodbury+CT",
    phone: "",
    phoneHref: "",
    email: "",
  },
  ...
  booking: {
    court: {
      type: "embed",
      demo: true,
      embedUrl: "https://book.woodbury-fit-on-main.example/schedule",
