/* =========================================================================
   WORKOUT HARDER FITNESS — CONCEPT SITE CONFIG
   -------------------------------------------------------------------------
...
window.SITE_CONFIG = {
  ...
  brand: {
    name: "Workout Harder Fitness",
    shortName: "WHF",
    tagline: "Strength & Specialty Classes in Vernon",
  },

  contact: {
    venueName: "Workout Harder Fitness",
    address: "Vernon, CT",
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Workout+Harder+Fitness+Vernon+CT",
    phone: "",
    phoneHref: "",
    email: "workoutharderfitness@gmail.com",
  },
  ...
  booking: {
    court: {
      type: "embed",
      demo: true,
      embedUrl: "https://book.workout-harder-fitness.example/schedule",
    ...
    pickleball: {
      ...
      fallbackEmail: {
        ...
        body: "Hi,\n\nI'd like to register for a specialty class.\n\nThank you!",
      },
    },
