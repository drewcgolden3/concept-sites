/* =========================================================================
   CROSSFIT HCC — CONCEPT SITE CONFIG
   -------------------------------------------------------------------------
...
window.SITE_CONFIG = {
  ...
  contact: {
    venueName: "CrossFit HCC",
    address: "North Haven/New Haven, CT",
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=CrossFit+HCC+North+Haven+CT",
    phone: "",
    phoneHref: "",
    email: "",
  },
  ...
  booking: {
    court: {
      type: "embed",
      demo: true,
      embedUrl: "https://book.crossfithcc.example/schedule",
      title: "Book a WOD",
