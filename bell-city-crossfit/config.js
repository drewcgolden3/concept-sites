/* =========================================================================
   BELL CITY CROSSFIT — CONCEPT SITE CONFIG
   -------------------------------------------------------------------------
...
window.SITE_CONFIG = {
  ...
  brand: {
    name: "Bell City CrossFit",
    shortName: "BC",
    tagline: "CrossFit in Bristol",
  },

  contact: {
    venueName: "Bell City CrossFit",
    address: "Bristol, CT",
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Bell+City+CrossFit+Bristol+CT",
    phone: "",
    phoneHref: "",
    email: "",
  },
  ...
  booking: {
    court: {
      type: "embed",
      demo: true,
      embedUrl: "https://book.bellcitycrossfit.example/schedule",
      title: "Book a WOD",
