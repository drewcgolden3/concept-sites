/* =========================================================================
   THE GYM NEWTOWN — CONCEPT SITE CONFIG
   -------------------------------------------------------------------------
...
window.SITE_CONFIG = {
  ...
  brand: {
    name: "The Gym Newtown",
    shortName: "TG",
    tagline: "Fitness for the Over-40 Crowd in Newtown",
  },

  contact: {
    venueName: "The Gym Newtown",
    address: "Newtown, CT",
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=The+Gym+Newtown+Newtown+CT",
    phone: "",
    phoneHref: "",
    email: "",
  },
  ...
  booking: {
    court: {
      type: "embed",
      demo: true,
      embedUrl: "https://book.the-gym-newtown.example/schedule",
      title: "Start a Trial",
