/* =========================================================================
   THE J FITNESS — CONCEPT SITE CONFIG
   -------------------------------------------------------------------------
...
window.SITE_CONFIG = {
  ...
  brand: {
    name: "The J Fitness",
    shortName: "TJ",
    tagline: "Community Fitness Center in Bridgeport",
  },

  contact: {
    venueName: "The J Fitness",
    address: "Bridgeport, CT",
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=The+J+Fitness+Bridgeport+CT",
    phone: "",
    phoneHref: "",
    email: "info@TheJFitness.com",
  },
  ...
  booking: {
    court: {
      type: "embed",
      demo: true,
      embedUrl: "https://book.the-j-fitness.example/schedule",
      title: "Start a Trial",
